          ...
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
	            ...
	            $sql=mysql_query("SELECT image,name,profession,status,rating,email FROM details");
				 while($row=mysql_fetch_array($sql))
					 //$sql[]=$row;
				      
	{                   
	                        $img=$row[image];
	                      echo "<form id=vform action=view.php method=POST>";	
	                      echo"<tr>";
		                  echo "<td>" . "<input type=hidden  name=email id=email    value=" . $row['email'] ." </td>";
                        
                          echo"<td class=py-1>";
                           echo"<img src='../forms/uploads/$img' >";
                          echo"</td>";
                          echo"<td>";
                          echo  $row['name'];
                          echo"</td>";
                          echo"<td>";
                           ...
                           echo"   <div class=progress-bar bg-warning role=progressbar style=width:".$row['rating']."% aria-valuenow=20 aria-valuemin=0 aria-valuemax=100></div>";
                            echo"</div>";
                         echo" </td>";
                         echo" <td>";
                          echo $row['profession'];
                        ...
                        echo"  </td>";
						echo" <td>";
						echo  "<input type=submit name=view id=view value=view class='btn btn-outline-primary btn-fw'>" ;
						echo"  </td>";
	                  echo" </tr>";
					  echo" </form>";
					  }

          ...
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
	            ...
	            $sql=mysql_query("SELECT booking.c_name, booking.mob_no,booking.service,booking.cleaner_name,cust_regi. user_name  from
booking JOIN cust_regi ON booking.c_name=cust_regi.email");
				 while($row=mysql_fetch_array($sql))
					 //$sql[]=$row;
				 
	{                   
	                      echo "<form id=vform action= method=POST>";	
	                      echo"<tr>";

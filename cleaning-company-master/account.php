      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Home</a><i class="fa fa-chevron-right"></i></a></span> <span>Account <i class="fa fa-chevron-right"></i></span></p>
				...
				<div class="row justify-content-center">
					<div class="col-md-12">
							...
							if(isset($_POST['delete']))
		               {
						   ...
						   $insert=mysql_query("INSERT INTO bookingdelete (`email`, `date`, `contact`, `service`, `cleaner_name`) VALUES('$name', '$bdate','$cont','$service','$cleaner_name')");
						   if($insert==true){
		                 $edit=mysql_query("DELETE FROM `booking` WHERE id=$id ");
						   }
						   else{
							   echo"NOT";
						   }
							...
							//if(isset($user_check)){
	                        $qry=mysql_query("SELECT  booking.id,booking.c_name,  booking.date,  booking.mob_no, booking.service,  booking.cleaner_name ,cust_regi.email FROM booking join cust_regi ON booking.c_name=cust_regi.email WHERE cust_regi.email='$user_check' ");
	              ...
	              {   $cleaner=$row['cleaner_name'];
						...
						echo"<div class='row no-gutters'>";
								...
								echo"		<h3 class='mb-4'>Booking History</h3>";
									echo"	<div id='form-message-warning' class='mb-4'></div> ";
					      		echo"<div id='form-message-success' class='mb-4'>";
					            
					      		echo"</div>";
								echo"		<form id=pform action=account.php  method=POST  class='contactForm'>";
									echo"		<div class='row'>";
									...
									echo"				<div class='form-group'>";
										...
										echo"		<div class='col-md-7'>";
										echo"			<div class='form-group'>";
										echo"				<label class=label for=name>Email</label>";
														
										echo"				<input type=text class='form-control' name=c_name id=c_name placeholder=Email value=" . $row['c_name'].">";
										echo"			</div>";
										echo"		</div>";
										echo"		<div class='col-md-8'> ";
										echo"			<div class='form-group'>";
											echo"			<label class='label'; for=email>Booking Date</label>";
										echo"				<input type=date class='form-control' name=date id=date placeholder=date value= ". $row['date'].">";
											echo"		</div>";
											echo"	</div>";
											echo"	<div class='col-md-11'>";
											echo"		<div class='form-group'>";
											echo"			<label class='label' for=username>Contact</label>";
											echo"			<input type=text class=form-control name=mob_no id=mob_no placeholder=Contact value= ". $row['mob_no'].">";
											echo"		</div>";
											echo"	</div>";
											/*echo"	<div class='col-md-11'>";
											echo"		<div class='form-group'>";
											...
											echo"		<div class='form-group'>";
											echo"			<label class='label' for=contact>Services</label>";
											echo"			<input type=text class='form-control' name=service id=service placeholder=service value= ". $row['service'].">";
											echo"		</div>";
											echo"	</div>";
											echo"	<div class='col-md-12'> ";
												echo"	<div class='form-group'>";
												echo"		<label class='label' for=address>Cleaner Name</label>";
												echo"		<input type=text class='form-control' name=cleaner_name id=cleaner_name placeholder=cleaner_name value= '$cleaner'>";
												echo"	</div>";
											echo"	</div>";
											...
											echo"	<div class='col-md-12'>";
												...
												echo"<button name=delete id=delete value=submit class='btn btn-primary'>Delete Booking</button>";

      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Home</a><i class="fa fa-chevron-right"></i></a></span> <span>Login <i class="fa fa-chevron-right"></i></span></p>
			...
			<div class="container">
				<div class="row justify-content-center">
							...
							<div class="row no-gutters">
								<div class="col-md-7">
									<div class="contact-wrap w-100 p-md-5 p-4">
										...
										<form method="POST" id="LoginForm" action="signin.php" name="LoginForm" onsubmit = "return(validate());" class="contactForm">
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<center><h5 class="text">Don't have an account?</h5>
														<a href="Signup.php" class="btn btn-primary px-4 py-3">Create Account</a><center>
													</div>
												</div>
											</div>
										</form>
					...
					<div class="col-md-12">
						...
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d121656.25373231898!2d75.84857628465052!3d17.661620501252532!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc5d082b54ac5d5%3A0x3c719de6c83710d0!2sSolapur%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1649927675519!5m2!1sen!2sin" width="900" height="900" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					</div>
				</div>
			</div>
		</section>

  ...
  <head>
	...
	<script type = "text/javascript">
	 function validate() {
         ...
         if( document.bookingForm.c_name.value == "" ) {
            alert( "Please provide your name!" );
            document.bookingForm.c_name.focus() ;
            return false;
         }
         if( document.bookingForm.date.value == "" ) {
          ...
          if( document.bookingForm.mob_no.value == "" ) {
            alert( "Please provide your mobile number!" );
            document.bookingForm.mob_no.focus() ;
            return false;
         }
         if( document.bookingForm.service.value == "" ) {
            alert( "Please select your service!" );
			 document.bookingForm.service.focus() ;
            return false;
         }
         return( true );
      }
    		...
    		<div class="row d-md-flex justify-content-center">
    			<div class="col-md-12">
	    			<div class="wrap-appointment bg-white d-md-flex pl-md-4 pb-5 pb-md-0">
	    				<form action="insert2.php" method="POST"  onsubmit="return(validate());"  id="bookingForm" name="bookingForm" class="appointment w-100">
	    					<div class="row justify-content-center">
				              ...
				              <input type="text" class="form-control" id="c_name" placeholder="Your Email" name="c_name">
				            </div>
									</div>
									<div class="col-12 col-md d-flex align-items-center pt-4 pt-md-0">
										<div class="form-group py-md-4 py-2 px-4 px-md-0">
				              ...
				              <input type="text" class="form-control" placeholder="mob_no" id="mob_no" name="mob_no">
				            </div>
									</div>
									
									<?php 
									error_reporting(0);
									echo"<div class='col-12 col-md d-flex align-items-center'>";
									echo"	<div class='form-group py-md-4 py-2 px-4 px-md-0'>";
										echo"	<label for='name'>Select Services</label>";
				    					echo"<div class='form-field'>";
		          					echo"<div class='select-wrap'>";
		                    echo"  <div class='icon'><span class='fa fa-chevron-down'></span></div>";
						
				          echo"  <select name=service id=service   onchange='FetchState(this.value)' class=form-control>";
		                    echo"  	<option value=''>Select Services</option>";
		                    echo"    <option value=OfficeCleaning>OfficeCleaning</option>";
		                     echo"   <option value=PoolCleaning>PoolCleaning</option>";
		                     echo"   <option value=CarpetCleaning>CarpetCleaning</option>";
		                    echo"    <option value=KitchenCleaning>KitchenCleaning</option>";
		                    echo"    <option value=GardenCleaning>GardenCleaning</option>";
		                    echo"    <option value=WindowCleaning>WindowCleaning></option>";
		                     echo" </select>";
				           ...
				           echo"   </div>";
							...
							echo"		</div>";
									...
									$qry=mysql_query("SELECT `name` FROM `details` WHERE  profession='$service'");
									echo"<div class='col-12 col-md d-flex align-items-center pb-4 pb-md-0'>";
									echo"	<div class='form-group py-md-4 py-2 px-4 px-md-0'>";
									echo"		<label for='name'>Name</label>";
				    				echo"	<div class='form-field'>";
		          					echo"<div class='select-wrap'>";
		                    echo"  <div class='icon'><span class='fa fa-chevron-down'></span></div>";
		                    echo"  <select name=cleaner_name id=cleaner_name class='form-control'>";
		                    echo"  	<option value=''>Select Cleaners</option>";
				           ...
				           echo"   </div>";
				    		echo"		</div>";
				              ...
				              <Button type="submit"  class="btn btn-primary py-3 px-4">Make A Booking</button>
				            </div>
									</div>
	    					</div>
		          </form>
